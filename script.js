...
function print(x){
  for(var n=(x-1)*5;n<5*x;i++){
    optdiv.innerHTML = " ";
    var request = new XMLHttpRequest();
    

    request.open('GET',"https://github.com/krishnakiriti04/Guvi-Tasks/blob/master/Pagination/script.js");
    request.send();
...
function createAnchorList() {
    ...
    for (let i = 1; i <= 10; i++) {
        ...
        a.setAttribute("style","margin-left:5%")
